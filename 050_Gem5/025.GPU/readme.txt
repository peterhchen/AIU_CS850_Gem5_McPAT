...
3. NVIDIA CUDA/HIP vs. AMD OpenCL: Thread, Warp, Thread Block, and Kernel.
...
We want to do the workloads once. Then, we skip the checkpoint/restore the configuration and start simulation after the restoration to the save run time. 
