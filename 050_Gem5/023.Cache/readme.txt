Topics:
We discuss the Cache Hierarchy with CHI (Coherence Hub Interface) protocol. CHI is created by ARM. Gem5 maintains the CHI. In Full System Simulation, we use a simple traffic generator to generate the traffic and set up the Chi Protocol with Gem5 Standard Library
